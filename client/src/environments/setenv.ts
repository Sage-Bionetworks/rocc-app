...
const isProduction = argv.env || false;
...
const SERVER_API_PATH = process.env.SERVER_API_PATH || undefined;
...
const envConfigFile = `
  export const environment = {
      ...
      apiBasePath: '${SERVER_PROTOCOL}${SERVER_DOMAIN}:${SERVER_PORT}${SERVER_API_PATH}',
      appVersion: '0.1.0',
